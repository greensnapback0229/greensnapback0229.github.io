...
Flux 스트리밍 중에 리뷰 문자열을 안전하게 누적하고, 스트림 완료 시 최종 결과를 한 번만 사용하기 위해서 <a href="https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/AtomicReference.html">`AtomicReference`</a>를 버퍼로 사용했습니다. 
