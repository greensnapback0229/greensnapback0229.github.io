...
summary: 
image_dir: /assets/posts/openai-streaming
---
...
[해당 글을 요약한 Notion 글입니다.](https://www.notion.so/ssj-leapday/LLM-token-streaming-34bd8a098a4f8066ba23c4410565b97b)
...
![reivew_seq]({{ page.image_dir }}/Mermaid Chart - Create complex, visual diagrams with text.-2026-01-20-175814.png)
...
![flux_seq]({{ page.image_dir }}/flux_seq-8955756.png)
...
![better_review_arc]({{ page.image_dir }}/better_review_arc.jpg)
...
Flux 스트리밍 중에 리뷰 문자열을 안전하게 누적하고, 스트림 완료 시 최종 결과를 한 번만 사용하기 위해서 <a href="https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/AtomicReference.html">`AtomicReference`</a>를 버퍼처럼 사용했습니다. 
...
SSE 성능 측정을 위해서 <a href="https://k6.io/">k6</a> 라는 툴을 사용했습니다. 
