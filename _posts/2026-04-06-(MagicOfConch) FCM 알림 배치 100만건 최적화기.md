...
# (MagicOfConch) FCM 알림 배치 100만건 최적화기

<br>

> MagicOfConch(마법의 소라고동) 프로젝트의 Streak 알림 배치를 단계적으로 개선한 기록입니다.
> Stack: Spring Batch, JPA, RabbitMQ, Prometheus, Grafana
> 한 시간에 100만 명에게 알림을 보내야 한다면 이 배치는 살아남을 수 있을까? 라는 질문에서 시작합니다.



## 어떤 기능인가?

소라고동에는 **회고 작성을 유도하는 푸시 알림** 기능이 있습니다.
...
![streak_batch_baseline](/assets/streak_batch_baseline.png)
...
![streak_batch_memory_oom](/assets/streak_batch_memory_oom.png)

![streak_batch_db_connection](/assets/streak_batch_db_connection.png)
...
![cursor-problem](/assets/cursor-problem.svg)
...
![streak_batch_keyset_result](/assets/streak_batch_keyset_result.png)

OOM 없이 1분 7초로 완주했습니다. 같은 구조를 그림으로 비교해보면 차이가 분명합니다.

![keyset-solution](/assets/keyset-solution.svg)
...
![streak_batch_fcm_latency](/assets/streak_batch_fcm_latency.png)
...
![streak_batch_io_bottleneck](/assets/streak_batch_io_bottleneck.png)
...
![streak_batch_rabbitmq_queue](/assets/streak_batch_rabbitmq_queue.png)
...
![streak_batch_concurrency_10](/assets/streak_batch_concurrency_10.png)
...
![streak_batch_partition_3](/assets/streak_batch_partition_3.png)
...
![streak_batch_mysql_spike](/assets/streak_batch_mysql_spike.png)
...
![streak_batch_architecture](/assets/streak_batch_architecture.png)
