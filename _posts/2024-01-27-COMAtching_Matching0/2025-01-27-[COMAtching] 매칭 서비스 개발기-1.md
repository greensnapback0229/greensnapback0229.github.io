...
tags: []
summary: 코매칭 서비스 개발기
image_dir: /assets/posts/comatching-matching1
---
...
아래는 매칭 서비스 플로우입니다.
![ver2_matching]({{ page.image_dir }}/comatching_2_matching_sequence_diagram.svg)
...
요청 순서도
![ver2_matching_prob]({{ page.image_dir }}/comatching2_csv_prob.png)
